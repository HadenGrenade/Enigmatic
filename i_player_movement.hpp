...
public:
	...
	virtual void check_moving_ground(CEntity* player, double frametime) = 0;
	virtual void run_command(CEntity* player, CUserCmd* cmd, player_move_helper* moveHelper) = 0;
	virtual void setup_move(CEntity* player, CUserCmd* cmd, player_move_helper* pHelper, player_move_data* move) = 0;
	virtual void finish_move(CEntity* player, CUserCmd* cmd, player_move_data* move) = 0;
	virtual void set_ideal_pitch(int nSlot, CEntity* player, const vec3_t& origin, const vec3_t& angles, const vec3_t& viewheight) = 0;
	virtual void check_error(int nSlot, CEntity* player, int commands_acknowledged) = 0;
